...
import {IGitHubRepo, IUser} from "@gitcode/data";
import {takeUntil} from "rxjs/operators";
import {Subject} from "rxjs";
import {AuthService} from "../../../../services/auth.service";
import {SETTINGS_DATA} from "../../../../data/dummy-settings.data";
...
export class SettingComponent implements OnInit {
  ...
  public settingData : ISettingsData[] = [];
  ...
  getProductData(){
    this.settingData= SETTINGS_DATA;
    // this.resultSetting= this.settingData.pipe()
...
export interface ISettingsData {
  ...
  payment_name:string,
  product_limit_line:number,
  product_used_line:number
}
